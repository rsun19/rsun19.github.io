    ...
    const portfolioItems = [
        {
            ...
            photo: tripPlanner,
            description: "Developed a mobile app that allows people to create trip itinenaries, view them on maps, and share them. It application uses Postgres, Flask, Firebase, token-based auth, and SQLite.",
            links: [
        ...
        },
        {
            ...
            description: "Developed a book blog using Flask, with Python as its backend and HTML, CSS, Tailwind CSS, and JavaScript for the front end. Users can use their Google Account to log in and create comments.",
            links: [
        ...
        },
        {
            ...
            description: "Developed a joke generator. I used React for the web component, and Swift for the iMessage extension component. For the backend, I used Flask and Postgres, and served content with an API.",
            links: [
        ...
        },
        {
            ...
            photo: recycleAI,
            title: "Pytorch",
            description: "Developed a model using PyTorch that can classify recyclable items. I trained ResNet18's pre-trained model with thousands of images and the model is 84% accurate on the testing data.",
            links: [
                        ...
                        {smH && <div className="pt-3">
                            ...
                            item.links.map((link) => (
                                <span id={link.id} className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm 2xl:text-md 4xl:text-xl 5xl:text:2xl font-semibold text-gray-700 mr-2 mb-2">
                                    <a href={link.link} target="_blank" style={{ padding: '10px 0px', color: 'black', textDecoration: 'none' }}>{link.name}</a>
                                </span>
                            ))
                            }
                        </div>}
