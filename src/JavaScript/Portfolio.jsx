...
const Portfolio = () => {
  ...
  const portfolioItems = [
    ...
    },
    {
      ...
      description:
        "Developed a book blog using Flask, with Python as its backend and HTML, CSS, Tailwind CSS, and JavaScript for the front end. The blog posts I create go directly towards a database, and users can use their Google Account to log in and create comments. It also incorporates the New York Times API to gather bestseller lists.",
      links: [
        {
          id: 1,
    ...
    },
    {
      ...
      links: [
        ...
        {
          id: 3,
          link: "https://github.com/rsun19/joke-generator-app",
          name: "View Swift code",
        },
        {
          id: 4,
          link: "https://github.com/rsun19/jokegenerator",
          name: "View React code",
        },
        {
          id: 5,
          link: "https://github.com/rsun19/joke_generator",
          name: "View Flask code",
        },
      ],
    },
    {
  ...
  return (
    <div>
      <h1
        className="pt-24 text-3xl 3xl:text-4xl 4xl:text-6xl mb-10 4xl:mb-20 5xl:text-7xl"
      ...
      <br />
      <h1
        className="text-3xl 3xl:text-3xl 4xl:text-6xl"
        style={{ textAlign: "center" }}
      >
      ...
      >
        <a
          href="https://github.com/rsun19/portfoliodev"
          target="_blank"
          style={{
